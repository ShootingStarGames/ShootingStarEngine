...
namespace shootingStar
{
	namespace math
	{
		...
		public:
			...
			static const Vector4 Abs(const Vector4& vector4);
			static const Vector4 Add(const Vector4& lhs, const Vector4& rhs);
			static const Vector4 Clamp(const Vector4& vector4, const Vector4& min, const Vector4& max);
			...
			static const Vector4 Negate(const Vector4& vector4);
			static const Vector4 Normalized(const Vector4 &vector4);
		...
		public:
			...
			static float Length(const Vector4 &vector4);
			static float LengthSquared(const Vector4 &vector4);
