...
namespace shootingStar
{
	namespace math
	{
		...
		public:
			...
			static const Vector2 Clamp(const Vector2& vector2, const Vector2& min, const Vector2& max);
			...
			static const Vector2 Project(const Vector2& vector2, const Vector2& axisVector);
			static const Vector2 Reflect(Vector2& dir, const Vector2& normal);
			static const Vector2 Normalized(const Vector2 &vector2);
			...
			static float Length(const Vector2 &vector2);
			static float LengthSquared(const Vector2 &vector2);
