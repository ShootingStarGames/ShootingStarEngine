...
namespace shootingStar
{
	namespace math
	{
		...
		public:
			...
			static const Vector3 Abs(const Vector3& vector3);
			static const Vector3 Add(const Vector3& lhs, const Vector3& rhs);
			static const Vector3 Clamp(const Vector3& vector3, const Vector3& min, const Vector3& max);
			...
			static const Vector3 Negate(const Vector3& vector3);
			static const Vector3 Project(const Vector3& vector3, const Vector3& axisVector);
			static const Vector3 Reflect(Vector3& dir, const Vector3& normal);
			static const Vector3 Normalized(const Vector3 &vector3);

		public:
			static float Distance(const Vector3& from, const Vector3& to);
			static float DistanceSquared(const Vector3& from, const Vector3& to);
			static float Length(const Vector3 &vector3);
			static float LengthSquared(const Vector3 &vector3);
